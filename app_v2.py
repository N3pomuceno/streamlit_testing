...
if st.session_state["form_submitted"]:
    ...
    if len(st.session_state.fr_model_order) == 1:
        ...
        # Envia a avaliação do usuário por email
        # util.send_email()
        st.session_state.most_liked_order = "{} > {}".format(
...
def show_interface():
    ...
    if st.session_state.order == 0:
        ...
        with st.expander("Fato Relevante", expanded=True):
            ...
            print("Hora da análise: {}".format(st.session_state.fr_model_order))
        ...
        with col3:
            parametros_texto1 = caracteristicas_texto("t1")
        with col4:
            parametros_texto2 = caracteristicas_texto("t2")
